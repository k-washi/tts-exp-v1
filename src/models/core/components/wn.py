...
class WN(nn.Module):
    def __init__(
        ...
        if self.speaker_id_embedding_dim != 0:
            condition_layer = nn.Conv1d(
                speaker_id_embedding_dim,
                2 * hidden_channels * n_resblocks,
                kernel_size=1,
                padding=0,
                dilation=1,
                bias=False,
    ...
    def forward(self, x, x_mask, speaker_id_embedded=None):
        ...
        for i in range(self.n_resblocks):
            ...
            if speaker_id_embedded is not None:
                ...
                speaker_fmap_selected = speaker_fmap[
