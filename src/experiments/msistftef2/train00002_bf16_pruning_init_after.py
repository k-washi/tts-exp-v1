...
from src.models.msistftef2.plmodule_cn_prune import MsISTFTEF2Module
...
VERSION = "00511"
EXP_ID = "msistft_ef2_accent_mblank_bf16_pruning010_init050"
...
P_G_MODEL = "logs/msistft_ef2_accent_mblank_bf16_pruning050_00510/ckpt/ckpt-530_best/net_g.pth"
P_D_MODEL = "logs/msistft_ef2_accent_mblank_bf16_pruning050_00510/ckpt/ckpt-530_best/net_d.pth"
P_W_MODEL = "logs/msistft_ef2_accent_mblank_bf16_pruning050_00510/ckpt/ckpt-530_best/wavlm_d.pth"
PRE_PRUNE_AMOUNT = 0.5
PRUNE_AMOUNT = 0.1

cfg.ml.num_epochs = 1000
...
cfg.model.optim_g.lr = 2e-5
cfg.model.optim_g.eps = 1e-4
cfg.model.optim_d.lr = 2e-5
cfg.model.optim_d.eps = 1e-4
cfg.model.scheduler_g.use = True
cfg.model.scheduler_d.use = True

cfg.model.scheduler_g.warmup_epoch = 20
cfg.model.scheduler_d.warmup_epoch = 20
...
cfg.model.net_g.prune_amount = PRUNE_AMOUNT
...
def train():
    ...
    model._apply_pruning(PRE_PRUNE_AMOUNT)
    model.net_g.load_state_dict(torch.load(P_G_MODEL))
    model.net_d.load_state_dict(torch.load(P_D_MODEL))
    model.wavlm_d.load_state_dict(torch.load(P_W_MODEL))
    
    model._apply_pruning(PRUNE_AMOUNT)
