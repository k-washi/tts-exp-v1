...
VERSION = "00402_noutomi_ft"
EXP_ID = "msistft_accent_mblank_noduradv"
WANDB_PROJECT_NAME = "vits-exp-noutomi-v1"
IS_LOGGING = True
FAST_DEV_RUN = False

PRETRAIN_GEN_MODEL = "logs/msistft_accent_mblank_noduradv_00402/ckpt/ckpt-1950/net_g.pth"
PRETRAIN_D_MODEL = "logs/msistft_accent_mblank_noduradv_00402/ckpt/ckpt-1950/net_d.pth"
PRETRAIN_WAVLM_D_MODEL = "logs/msistft_accent_mblank_noduradv_00402/ckpt/ckpt-1950/wavlm_d.pth"
...
cfg.path.dataset_dir = "data/noutomi_jsut"
...
def train():
    ...
    model.wavlm_d.load_state_dict(torch.load(PRETRAIN_WAVLM_D_MODEL))
