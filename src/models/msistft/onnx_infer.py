...
class VitsInferenceModel():
    ...
    def inference(
        ...
        kana=False, 
        phoneme=False,
        add_blank_type=2, # 0: なし, 1: 音素の前後に挿入, 2: モーラの前後に挿入
        accent_split=True, # アクセントを分割するか
        ...
        print("Input:", x)
        print("Symbol:", "-".join(symbol_list))
        phonome_list, accent_list = symbol_preprocess(
            symbol_list,
            add_blank_type=add_blank_type,
            accent_split=accent_split,
            accent_up_ignore=accent_up_ignore
        )
...
if __name__ == "__main__":
    ...
    #^-o-[-ky-a-k-u-s-a-]-m-a-n-o-#-k-a-[-d-a-i-k-a-]-i-k-e-ts-u-n-i-#-a-[-t-a-cl-t-e-_-_-a-]-r-a-t-a-n-a-#-t-e-[-k-u-n-o-]-r-o-j-i-i-o-#-k-a-[-ts-u-y-o-o-#-sh-i-[-t-a-#-k-a-[-k-u-sh-u-# sh-i-[-s-u-t-e-m-u-k-a-]-i-h-a-ts-u-k-a-r-a-#-k-a-[-k-u-sh-u-k-o-N-s-a-]-r-u-t-i-N-g-u-m-a-d-e-_-s-a-[-m-a-]-z-a-m-a-n-a-#-s-a-]-a-b-i-s-u-o-#-h-a-[-b-a-h-i-r-o-]-k-u-#-t-e-[-e-ky-o-o-#-sh-i-[-t-e-#-i-[-m-a-]-s-u-$
    parser = argparse.ArgumentParser()
    parser.add_argument("--checkpoint", type=str, default="./logs/msistft_accent_mblank_noduradv_00402_noutomi_ft/net_g_c_noutomi_smistft_ep3450.onnx")
    parser.add_argument("--text", type=str, default="お客様の課題解決にあたって、新たなテクノロジーを活用した各種システム開発から、各種コンサルティングまで、様々なサービスを幅広く提供しています。")
